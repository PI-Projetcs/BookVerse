						...
						<View style={styles.contentInner}>
							...
							<View style={styles.sectionCard}>
								<View style={styles.sectionHeaderRow}>
									...
									<Text style={styles.sectionTitle}>Comentarios dos Membros</Text>
								</View>
								{memberComments.length ? (
									<View style={styles.commentsList}>
										{memberComments.map((comment) => (
											<View key={comment.id} style={styles.commentItem}>
												...
												<Text style={styles.commentText}>{comment.text || 'Sem comentario.'}</Text>
											</View>
										))}
									</View>
								) : (
									<Text style={styles.commentsEmptyText}>Ainda nao existem comentarios para este livro.</Text>
								)}
							</View>
						</View>
					</ScrollView>
