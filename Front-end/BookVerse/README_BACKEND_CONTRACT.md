...
Implementei o fluxo de autenticação com token no app. O login e o cadastro agora passam por authService.js, a sessão salva inclui token em AuthContext.js, e o cliente HTTP centralizado em api.js injeta Authorization: Bearer automaticamente nas chamadas. Também conectei a tela de login em LoginScreen.js e passei as services para usar esse cliente autenticado, como em bookService.js, homeService.js e adminService.js. A navegação inicial agora exige sessão com role e token em sessionRoute.js.rt