...
1. **MapStruct**: Migrar mappers manuais para MapStruct para reduzir código boilerplate.
2. **Flyway/Liquibase**: Implementar versionamento de banco de dados para facilitar migrações em equipe.
3. **Caché (Redis)**: Implementar cache para listagens de livros e categorias para melhorar o desempenho.
4. **Cloud Storage**: Integrar com AWS S3 ou Azure Blob Storage para upload de capas de livros.
